...
/**
 * This class is based on AOSP MathUtils
 *
 * ref: https://android.googlesource.com/platform/frameworks/base/+/master/core/java/android/util/MathUtils.java
 *
 * A class that contains utility methods related to numbers.
 *
 * @hide Pending API council approval
 */
final class RatingBarMathUtils {
    private RatingBarMathUtils() {
    }
